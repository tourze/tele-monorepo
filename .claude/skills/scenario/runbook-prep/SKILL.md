...
description: 当需要编写或维护 Runbook，覆盖操作步骤、监控、回滚与应急联络时，请加载本技能。
...
- 确认 Runbook 覆盖的服务范围、环境（生产/预生产）以及 SLA/SLO 要求。
- 收集现有文档、脚本、监控看板、报警策略、联系人名单，标注更新时间。
- 约定 Runbook 的存放位置、命名规范与版本管理方式（Git/Wiki）。
- 准备访谈提纲，与开发、运维、值班人员确认实际操作细节与风险点。
