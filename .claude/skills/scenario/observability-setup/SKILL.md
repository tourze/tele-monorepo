...
description: 当需要构建或完善观测体系，涵盖日志、指标、Tracing 与报警策略以支撑上线时，请加载本技能。
...
- 明确服务拓扑与关键依赖，收集现有监控、日志、追踪配置及缺口。
- 与平台/运维团队确认可用的观测组件（Prometheus、Grafana、OpenTelemetry Collector 等）及权限。
- 获取 SLO、SLA、错误预算、报警责任人列表，确定需要覆盖的业务指标。
- 搭建验证环境或演练沙箱，准备 Chaos/冒烟脚本，以便验证报警链路。
