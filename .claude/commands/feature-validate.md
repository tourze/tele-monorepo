...
- @.claude/skills/method/business-impact-engineering/SKILL.md ：Value Brief、指标链路、护栏指标、单位经济目标、实验设计。
- @.claude/skills/scenario/feature-validation/SKILL.md ：验收标准对照、质量门执行、修复任务编号。
- @.claude/skills/scenario/quality-gates/SKILL.md ：格式、静态分析、测试、依赖、构建的目标化执行。
- @.claude/skills/method/risk-matrix/SKILL.md ：评估失败项风险，决定阻塞或豁免。
- @.claude/skills/method/context-snapshot/SKILL.md （可选）：生成验证快照，支持长流程沟通。
