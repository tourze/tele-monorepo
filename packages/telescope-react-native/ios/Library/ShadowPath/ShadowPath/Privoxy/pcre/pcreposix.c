...
size_t
pcre_regerror(int errcode, const s_regex_t *preg, char *errbuf, size_t errbuf_size)
{
...
int
pcre_regcomp(s_regex_t *preg, const char *pattern, int cflags)
{
const char *errorptr;
int erroffset;
int options = 0;
...
int
pcre_regexec(s_regex_t *preg, const char *string, size_t nmatch,
